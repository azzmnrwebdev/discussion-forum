...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('collection.index') }}">{{ __('My Collection') }}</a></li>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="replyCommentModalLabel">Reply
                                                            Comment</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('comments.reply', $comment->id) }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-form-label">Reply Comment</label>
                                                                ...
                                                                <small id="contentHelp"
                                                                    class="form-text text-muted">Comments cannot exceed
                                                                    300 characters.</small>
                                                    ...
                                                    @foreach ($comment->replies as $reply)
                                                        <article>
                                                            ...
                                                            <p class="card-text post-date">
                                                                {{ $reply->formattedTimestamp($reply->created_at) }}
                                                            </p>
                                                        </article>
                                                    @endforeach
                                                </div>
