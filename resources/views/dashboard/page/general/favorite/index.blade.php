...
@section('title-head', 'Dashboard - My Favorite')
@section('title-content', 'My Favorite')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('My Favorite') }}</li>
@endsection
            ...
            <div class="row">
                <div class="col-sm-10 col-lg-8 col-xl-6 py-4">
                    ...
                    @forelse ($favoritedPosts as $post)
                        <x-post-card
                            :postLink="route('favorite.show', $post->slug)"
...
<script>
    $(document).ready(function() {
        const favoritedPosts = @json($favoritedPosts);

        favoritedPosts.forEach(function(post, index) {
