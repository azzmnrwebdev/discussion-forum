...
@prepend('styles')
    <style>
        ...
        #recentPostsModal .modal-dialog .modal-content .modal-body ul li a {
            color: #6B6B6B;
        }

        .btn-user-liked-modal:hover,
        .btn-user-favorited-modal:hover,
        .btn-recent-posts-modal:hover,
        ...
        #recentPostsModal .modal-dialog .modal-content .modal-body ul li:hover a {
            cursor: pointer;
            color: #191919;
            text-decoration: underline;
        }
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.posts.index') }}">{{ __('Manage Posts') }}</a></li>
...
@section('content')
                ...
                <div class="col-sm-10 col-lg-8 col-xl-6">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="javascript:void(0)" class="btn-user-favorited-modal" data-toggle="modal"
                            ...
                            Favorited</a>
                        <a href="javascript:void(0)" class="btn-recent-posts-modal" data-toggle="modal"
                            data-target="#recentPostsModal">Recent Posts</a>
                    </div>
    ...
    {{-- recent posts modal --}}
    <div class="modal fade" id="recentPostsModal" tabindex="-1" aria-labelledby="recentPostsModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="recentPostsModalLabel">User Favorited ({{ count($recentPosts) }})</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    @if (count($recentPosts) > 0)
                        <ul class="pl-0 ml-3 mb-0 d-inline-block">
                            @foreach ($recentPosts as $item)
                                <li class="card-text">
                                    <a
                                        href="{{ route('admin.posts.show', ['username' => $item->user->username, 'slug' => $item->slug]) }}">{{ $recentPost->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    @else
